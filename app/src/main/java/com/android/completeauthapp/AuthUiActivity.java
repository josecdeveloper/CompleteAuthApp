...
public class AuthUiActivity extends AppCompatActivity {
    ...
    private static final String TWITTER_KEY = "FbaTwCGU7zznbeUyTrsiVjvUa";
    private static final String TWITTER_SECRET = "qYX6qKCcB8VK1Oh7DGwdA9lvzl0cNMAwrdp7BCvHZ6rUgxuKwN";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ButterKnife.bind(AuthUiActivity.this);
    ...
    private int getSelectedLogo() {
        ...
        if (mFirebaseLogo.isChecked()) {
            ...
            return R.drawable.logo_googleg_color_18dp;
        }
